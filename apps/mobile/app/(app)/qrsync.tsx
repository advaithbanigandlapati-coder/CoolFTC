...
export default function QRSyncScreen() {
  ...
  return (
    <ScrollView style={s.container} contentContainerStyle={s.content}>
      <Text style={{ color: C.accent, fontSize: 10, letterSpacing: 3, marginBottom: 2 }}>SCOUT SUITE</Text>
      <Text style={{ color: C.text, fontSize: 28, fontWeight: "900", letterSpacing: 2, marginBottom: 12 }}>QR SYNC</Text>
