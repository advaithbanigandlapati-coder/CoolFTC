      ...
      {tab === "match" && (<>
        ...
        <Card>
          ...
          <View
            ...
            style={{ width: 320, height: 320, borderRadius: 6, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", alignSelf: "center", position: "relative", overflow: "hidden" }}>
            <Image source={require("../../assets/field.png")} style={{ position: "absolute", width: "100%", height: "100%" }} resizeMode="cover" />
