        ...
        <Card>
          ...
          <View
            ...
            onResponderRelease={(e) => {
              ...
              const FIELD_W = 320; const FIELD_H = 213;
            ...
            style={{ width: 320, height: 213, backgroundColor: "#0F0F17", borderRadius: 6, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", alignSelf: "center", position: "relative", overflow: "hidden" }}>
            <View style={{ position: "absolute", left: 160, top: 0, bottom: 0, width: 1, backgroundColor: "rgba(255,255,255,0.05)" }} />
            <View style={{ position: "absolute", top: 106, left: 0, right: 0, height: 1, backgroundColor: "rgba(255,255,255,0.05)" }} />
            <Text style={{ position: "absolute", top: 4, left: 6, color: "rgba(255,255,255,0.25)", fontSize: 8 }}>AUDIENCE</Text>
            <Text style={{ position: "absolute", top: 4, right: 6, color: "rgba(255,255,255,0.25)", fontSize: 8 }}>FAR</Text>
