      ...
      {tab === "event" && (
        <div className="space-y-4">
          <div className="card p-4 space-y-3">
            ...
            <p className="font-mono text-[10px] text-white/30">Type a code directly, or click <span className="text-accent">Find →</span> to search by event name. Real FIRST event codes look like <span className="text-white/60">2025-USCAFFFAQ</span>.</p>
          </div>
          <div className="card p-4 space-y-3">
