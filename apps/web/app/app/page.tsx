    ...
    return (
      <div className="p-6 max-w-2xl">
        <div className="card p-8 text-center">
          <div className="font-mono text-[10px] text-accent tracking-widest mb-2">NO ORGANIZATION</div>
          <h1 className="font-display text-2xl font-black tracking-wide mb-3">Welcome to CoolFTC</h1>
          <p className="text-sm text-white/60 mb-5">
            Your account isn&apos;t linked to a team yet. Ask a teammate for an invite link,
            or create your own organization.
          </p>
          <a href="/signup" className="btn-primary inline-block px-6 py-2">Create an organization →</a>
        </div>
      </div>
    );
  }
